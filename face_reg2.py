...
st.markdown("<h1 style = 'color: #FF6000'>THE ODOGWU AND SONS INTERNATIONAL  </h1> ", unsafe_allow_html = True)
st.markdown("<h6 style = 'top_margin: 0rem; color: #27E1C1'>Built by Chinedu </h6>", unsafe_allow_html = True)

#Add an Image to the page
st.image('face 1.jpg', caption = 'FACE DETECTOR', width = 600)
...
# st.button("SUBMIT")
if (st.button("SUBMIT")):
    st.write (f"Welome {user_name} to the odogwu and sons International!!!")
